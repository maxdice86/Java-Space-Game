...
public class Bullets extends Sprite{
	...
	public Bullets(double x, double y, double z, double w, double h, int angle, double vx, double vy, ID id, String t) 
	{
			...
			switch(type) 
			{
			case "en1":    loadAnimation("shot1","/Enemies/Eshot", 1, 1); break;
			case "en2":    loadAnimation("shot2","/Enemies/bulletsG", 3, 2); break;
			case "en3":    break;
			case "pl":     loadAnimation("fired","/Player/shoot", 2, 4); break;
			case "pw":     loadAnimation("pw","/Player/b2", 10, 10); break;
			case "bos":    loadAnimation("boss","/Enemies/bossShot", 2, 1); break;
			}
...
//	   collisionMap.draw3D(g);
        ...
        case Bullet:
        	...
        	else g.drawImage(animator.get("fired").getCurrentImage(),x, y, sw, sh, null);
