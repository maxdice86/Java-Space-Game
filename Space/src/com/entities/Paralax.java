...
//////Applies 3D NO Camera/////////
	...
	public void draw2D(Graphics2D g)
	{
		   ...
		   if(z - Camera3D.z > 10)
			   ...
			   g.drawImage(image, (int) (sx - sw/2 + Camera3D.origin_x), (int)(sy - sh + Camera3D.origin_y), (int)sw, (int)sh, null);
	...
	public void draw3D(Graphics2D g)
	{
		 ...
		 // g.drawImage(image, (int) (w*i + px), (int)(py + h * i), (int)sw, (int)sh, null);
		  //g.drawImage(image, (int) (w*i + px), (int)(py - h * i), (int)sw, (int)sh, null);
		 ...
		 // g.drawRect( (int)Camera3D.x, (int)Camera3D.y , 100, 100);
		  ...
		  if (px < - sw)
		  {
			 ...
			 System.out.println("px: " + px +" py: "+  py + " sw: " + sw + " sh: " + sh + " x: " + x + " Cam " + Camera3D.x );
