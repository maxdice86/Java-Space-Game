...
public class Circle 
{
	...
	public void launch(Circle[] bullet)
	{
		if(launch_delay == 0)
		{
	      ...
	      bulletNum++;
	   	...
	   	if(bulletNum == bullet.length)  bulletNum = 0;
   ...
   public boolean within(double distance, Circle c)
   {
	...
	public void draw3D(Graphics2D g)
	{
		...
		g.drawLine((int)(sx + Camera3D.origin_x), (int)(sy + Camera3D.origin_y),(int) ((sx + Camera3D.origin_x) + (sw/2 * cosA )),(int)((sy + Camera3D.origin_y) + (sw/2 * sinA)));
