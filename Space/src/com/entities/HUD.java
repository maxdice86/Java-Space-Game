...
//		leftbounds   = new Line(32, 640, 32, 64);
		...
		rightbounds = new Line(Camera3D.origin_x - 32, -Camera3D.origin_y + 64, Camera3D.origin_x - 32,
				Camera3D.origin_y);

		leftbounds = new Line(-Camera3D.origin_x + 32, Camera3D.origin_y + 320, -Camera3D.origin_x + 32,
				-Camera3D.origin_y + 64);
	}
