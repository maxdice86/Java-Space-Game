...
public class Player extends Sprite implements ActionListener {
	...
	public void fire() {
		...
		if (firerate == 0) {
	    	  ...
	    	  case 1:
	    	   ...
	    	   Engine.obj_manager.allobjects.add(new Bullets(px + 32, py - 12, 512, 24, 8, 0,
	    			   10 * Lookup.cos[A], 10 * Lookup.sin[A], ID.Bullet, "pl"));
	    	  ...
	    	  case 2:
	    		  ...
	    		  Engine.obj_manager.allobjects.add(new Bullets(px + 32, py - 12, 512, 32, 8, 0,
		    			   10 * Lookup.cos[180], 10 * Lookup.sin[180], ID.Bullet, "pw"));
	    	  ...
	    	  case 3:
	    		  ...
	    		  Engine.obj_manager.allobjects.add(new Bullets(px + 32, py - 12, 512, 32, 8, 0,
		    			   10 * Lookup.cos[345], 10 * Lookup.sin[345], ID.Bullet, "pw"));
	    		  
	    		  
	    		  Engine.obj_manager.allobjects.add(new Bullets(px + 32, py - 12, 512, 32, 8, 0,
		    			   10 * Lookup.cos[25], 10 * Lookup.sin[25], ID.Bullet, "pw"));
	...
	public void checkMovements() {
		...
		if (enabled ) {		
				...
				if (InputManager.sp_pressed ) fire();					
			} 
	}
	...
	public void upgrade()
	{
		...
		{
		case 30:  guns = 2; break;
		case 60:  guns = 2; movespeed = 6; break;
		case 80: guns =  3;  movespeed = 6; break;	
		}
	}
