...
public class StartScreen extends GameState {
	...
	public void checkSelected()
	{
       ...
       { System.exit(0);}
		...
		else if (selected == 3 && InputManager.m_pressed || selected == 3 && InputManager.en_pressed ) {  goBack();    } 
	...
	public void render(Graphics2D g)
	{
			...
			
		{
				...
				} else playButton.draw3D(g, false);
		       ...
		       if (selected==1) {
				...
				} else optionButton.draw3D(g, false);
		       ...
		       if (selected==0) {
				...
				} else exitButton.draw3D(g, false);
		
		 } 
		
	   if (fade) faderOut.render(g);
